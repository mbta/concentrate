...
'e_enum_TripUpdate.StopTimeUpdate.ScheduleRelationship'('NO_DATA',
							Bin, _TrUserData) ->
    <<Bin/binary, 2>>;
'e_enum_TripUpdate.StopTimeUpdate.ScheduleRelationship'('UNSCHEDULED',
							Bin, _TrUserData) ->
    <<Bin/binary, 3>>;
...
'e_enum_Alert.Effect'('NO_EFFECT', Bin, _TrUserData) ->
    <<Bin/binary, 10>>;
'e_enum_Alert.Effect'('ACCESSIBILITY_ISSUE', Bin,
		      _TrUserData) ->
    <<Bin/binary, 11>>;
...
'e_enum_TripDescriptor.ScheduleRelationship'('CANCELED',
					     Bin, _TrUserData) ->
    <<Bin/binary, 3>>;
'e_enum_TripDescriptor.ScheduleRelationship'('REPLACEMENT',
					     Bin, _TrUserData) ->
    <<Bin/binary, 5>>;
...
dfp_read_field_def_EntitySelector(<<42, Rest/binary>>,
    ...
    d_field_EntitySelector_stop_id(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, F@_6, TrUserData);
dfp_read_field_def_EntitySelector(<<48, Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				  TrUserData) ->
    d_field_EntitySelector_direction_id(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, F@_6,
					TrUserData);
...
dg_read_field_def_EntitySelector(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_EntitySelector_stop_id(Rest, 0, 0, F@_1, F@_2,
					 F@_3, F@_4, F@_5, F@_6, TrUserData);
      48 ->
	  d_field_EntitySelector_direction_id(Rest, 0, 0, F@_1,
					      F@_2, F@_3, F@_4, F@_5, F@_6,
					      TrUserData);
      _ ->
	  case Key band 7 of
...
d_field_EntitySelector_direction_id(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				    TrUserData)
    when N < 57 ->
    d_field_EntitySelector_direction_id(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					F@_5, F@_6, TrUserData);
d_field_EntitySelector_direction_id(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, _,
				    TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
...
'd_enum_TripUpdate.StopTimeUpdate.ScheduleRelationship'(2) ->
    'NO_DATA';
'd_enum_TripUpdate.StopTimeUpdate.ScheduleRelationship'(3) ->
    'UNSCHEDULED';
...
'd_enum_TripDescriptor.ScheduleRelationship'(3) ->
    'CANCELED';
'd_enum_TripDescriptor.ScheduleRelationship'(5) ->
    'REPLACEMENT';
...
merge_msg_EntitySelector(PMsg, NMsg, TrUserData) ->
    ...
    case {PMsg, NMsg} of
      {_, #{direction_id := NFdirection_id}} ->
	  S6#{direction_id => NFdirection_id};
      {#{direction_id := PFdirection_id}, _} ->
	  S6#{direction_id => PFdirection_id};
      _ -> S6
    end.
...
v_msg_EntitySelector(#{} = M, Path, TrUserData) ->
    ...
    case M of
      #{direction_id := F6} ->
	  v_type_uint32(F6, [direction_id | Path], TrUserData);
      _ -> ok
    end,
...
'v_enum_TripUpdate.StopTimeUpdate.ScheduleRelationship'('NO_DATA',
							_Path, _TrUserData) ->
    ok;
'v_enum_TripUpdate.StopTimeUpdate.ScheduleRelationship'('UNSCHEDULED',
							_Path, _TrUserData) ->
    ok;
...
'v_enum_Alert.Effect'('NO_EFFECT', _Path,
		      _TrUserData) ->
    ok;
'v_enum_Alert.Effect'('ACCESSIBILITY_ISSUE', _Path,
		      _TrUserData) ->
    ok;
...
'v_enum_TripDescriptor.ScheduleRelationship'('CANCELED',
					     _Path, _TrUserData) ->
    ok;
'v_enum_TripDescriptor.ScheduleRelationship'('REPLACEMENT',
					     _Path, _TrUserData) ->
    ok;
...
get_msg_defs() ->
	...
	{occurrence, optional}, {opts, []}],
       [{name, direction_id}, {fnum, 6}, {rnum, 7},
	{type, uint32}, {occurrence, optional}, {opts, []}]]},
     {{msg, 'TranslatedString.Translation'},
...
'enum_symbol_by_value_TripUpdate.StopTimeUpdate.ScheduleRelationship'(2) ->
    'NO_DATA';
'enum_symbol_by_value_TripUpdate.StopTimeUpdate.ScheduleRelationship'(3) ->
    'UNSCHEDULED'.
...
'enum_value_by_symbol_TripUpdate.StopTimeUpdate.ScheduleRelationship'('NO_DATA') ->
    2;
'enum_value_by_symbol_TripUpdate.StopTimeUpdate.ScheduleRelationship'('UNSCHEDULED') ->
    3.
...
'enum_symbol_by_value_Alert.Effect'(11) ->
    'ACCESSIBILITY_ISSUE'.
...
'enum_value_by_symbol_Alert.Effect'('ACCESSIBILITY_ISSUE') ->
    11.
...
'enum_symbol_by_value_TripDescriptor.ScheduleRelationship'(3) ->
    'CANCELED';
'enum_symbol_by_value_TripDescriptor.ScheduleRelationship'(5) ->
    'REPLACEMENT'.
...
'enum_value_by_symbol_TripDescriptor.ScheduleRelationship'('CANCELED') ->
    3;
'enum_value_by_symbol_TripDescriptor.ScheduleRelationship'('REPLACEMENT') ->
    5.
...
fqbin_to_msg_name(<<"transit_realtime.TripUpdate.StopTimeEvent">>) ->
    'TripUpdate.StopTimeEvent';
fqbin_to_msg_name(<<"transit_realtime.TripUpdate.StopTimeUpdate">>) ->
    'TripUpdate.StopTimeUpdate';
...
fqbin_to_msg_name(<<"transit_realtime.TranslatedString.Translation">>) ->
    'TranslatedString.Translation';
...
msg_name_to_fqbin('TripUpdate.StopTimeEvent') ->
    <<"transit_realtime.TripUpdate.StopTimeEvent">>;
msg_name_to_fqbin('TripUpdate.StopTimeUpdate') ->
...
msg_name_to_fqbin('TranslatedString.Translation') ->
...
fqbin_to_enum_name(<<"transit_realtime.FeedHeader.Incrementality">>) ->
    'FeedHeader.Incrementality';
fqbin_to_enum_name(<<"transit_realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship">>) ->
    'TripUpdate.StopTimeUpdate.ScheduleRelationship';
fqbin_to_enum_name(<<"transit_realtime.VehiclePosition.VehicleStopStatus">>) ->
    'VehiclePosition.VehicleStopStatus';
fqbin_to_enum_name(<<"transit_realtime.VehiclePosition.CongestionLevel">>) ->
    'VehiclePosition.CongestionLevel';
fqbin_to_enum_name(<<"transit_realtime.VehiclePosition.OccupancyStatus">>) ->
    'VehiclePosition.OccupancyStatus';
...
fqbin_to_enum_name(<<"transit_realtime.TripDescriptor.ScheduleRelationship">>) ->
    'TripDescriptor.ScheduleRelationship';
fqbin_to_enum_name(E) ->
    error({gpb_error, {badenum, E}}).


enum_name_to_fqbin('FeedHeader.Incrementality') ->
    <<"transit_realtime.FeedHeader.Incrementality">>;
enum_name_to_fqbin('TripUpdate.StopTimeUpdate.ScheduleRelationship') ->
    <<"transit_realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship">>;
enum_name_to_fqbin('VehiclePosition.VehicleStopStatus') ->
    <<"transit_realtime.VehiclePosition.VehicleStopStatus">>;
enum_name_to_fqbin('VehiclePosition.CongestionLevel') ->
    <<"transit_realtime.VehiclePosition.CongestionLevel">>;
enum_name_to_fqbin('VehiclePosition.OccupancyStatus') ->
...
enum_name_to_fqbin('TripDescriptor.ScheduleRelationship') ->
...
get_msg_containment("gtfs-realtime") ->
    ['Alert', 'EntitySelector', 'FeedEntity', 'FeedHeader',
     'FeedMessage', 'Position', 'TimeRange',
...
get_enum_containment("gtfs-realtime") ->
    ['Alert.Cause', 'Alert.Effect', 'Alert.SeverityLevel',
     'FeedHeader.Incrementality',
     'TripDescriptor.ScheduleRelationship',
     'TripUpdate.StopTimeUpdate.ScheduleRelationship',
     'VehiclePosition.CongestionLevel',
...
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.VehicleDescriptor">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.TripDescriptor">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.FeedHeader">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.EntitySelector">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.TripUpdate.StopTimeEvent">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.Alert">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.TripUpdate.StopTimeUpdate">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.TripUpdate">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.TimeRange">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.FeedMessage">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.TranslatedString">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.FeedEntity">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.VehiclePosition">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.TranslatedString.Translation">>) ->
    "gtfs-realtime";
get_proto_by_msg_name_as_fqbin(<<"transit_realtime.Position">>) ->
    "gtfs-realtime";
...
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship">>) ->
    "gtfs-realtime";
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.TripDescriptor.ScheduleRelationship">>) ->
    "gtfs-realtime";
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.VehiclePosition.VehicleStopStatus">>) ->
    "gtfs-realtime";
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.VehiclePosition.OccupancyStatus">>) ->
    "gtfs-realtime";
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.Alert.Effect">>) ->
    "gtfs-realtime";
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.Alert.Cause">>) ->
    "gtfs-realtime";
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.FeedHeader.Incrementality">>) ->
    "gtfs-realtime";
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.VehiclePosition.CongestionLevel">>) ->
    "gtfs-realtime";
get_proto_by_enum_name_as_fqbin(<<"transit_realtime.Alert.SeverityLevel">>) ->
    "gtfs-realtime";
