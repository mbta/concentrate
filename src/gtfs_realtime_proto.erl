...
-type 'FeedHeader'() ::
      #{gtfs_realtime_version   => iodata(),        % = 1, required
...
-type 'TripDescriptor'() ::
      #{trip_id                 => iodata(),        % = 1, optional
        route_id                => iodata(),        % = 5, optional
        direction_id            => non_neg_integer(), % = 6, optional, 32 bits
        start_time              => iodata(),        % = 2, optional
        start_date              => iodata(),        % = 3, optional
...
-type 'VehicleDescriptor'() ::
      #{id                      => iodata(),        % = 1, optional
        label                   => iodata(),        % = 2, optional
        license_plate           => iodata()         % = 3, optional
       }.

-type 'EntitySelector'() ::
      #{agency_id               => iodata(),        % = 1, optional
        route_id                => iodata(),        % = 2, optional
        route_type              => integer(),       % = 3, optional, 32 bits
        trip                    => 'TripDescriptor'(), % = 4, optional
        stop_id                 => iodata(),        % = 5, optional
        direction_id            => non_neg_integer() % = 6, optional, 32 bits
       }.

-type 'TranslatedString.Translation'() ::
      #{text                    => iodata(),        % = 1, required
        language                => iodata()         % = 2, optional
       }.
