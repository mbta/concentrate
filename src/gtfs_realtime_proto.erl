...
-type 'TripUpdate.TripProperties'() ::
      #{trip_id                 => unicode:chardata(), % = 1, optional
        ...
        trip_headsign           => unicode:chardata(), % = 5, optional
        trip_short_name         => unicode:chardata() % = 6, optional
       }.
...
'encode_msg_TripUpdate.TripProperties'(#{} = M, Bin, TrUserData) ->
    ...
    B5 = case M of
             #{trip_headsign := F5} -> begin TrF5 = id(F5, TrUserData), e_type_string(TrF5, <<B4/binary, 42>>, TrUserData) end;
             _ -> B4
         end,
    case M of
        #{trip_short_name := F6} -> begin TrF6 = id(F6, TrUserData), e_type_string(TrF6, <<B5/binary, 50>>, TrUserData) end;
        _ -> B5
    end.
...
'decode_msg_TripUpdate.TripProperties'(Bin, TrUserData) ->
    'dfp_read_field_def_TripUpdate.TripProperties'(Bin, 0, 0, 0, id('$undef', TrUserData), id('$undef', TrUserData), id('$undef', TrUserData), id('$undef', TrUserData), id('$undef', TrUserData), id('$undef', TrUserData), TrUserData).

'dfp_read_field_def_TripUpdate.TripProperties'(<<10, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_TripUpdate.TripProperties_trip_id'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_TripUpdate.TripProperties'(<<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_TripUpdate.TripProperties_start_date'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_TripUpdate.TripProperties'(<<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_TripUpdate.TripProperties_start_time'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_TripUpdate.TripProperties'(<<34, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_TripUpdate.TripProperties_shape_id'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_TripUpdate.TripProperties'(<<42, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_TripUpdate.TripProperties_trip_headsign'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_TripUpdate.TripProperties'(<<50, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_TripUpdate.TripProperties_trip_short_name'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_TripUpdate.TripProperties'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, _) ->
    S1 = #{},
    S2 = if F@_1 == '$undef' -> S1;
    ...
    S6 = if F@_5 == '$undef' -> S5;
            true -> S5#{trip_headsign => F@_5}
         end,
    if F@_6 == '$undef' -> S6;
       true -> S6#{trip_short_name => F@_6}
    end;
'dfp_read_field_def_TripUpdate.TripProperties'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'dg_read_field_def_TripUpdate.TripProperties'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'dg_read_field_def_TripUpdate.TripProperties'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 32 - 7 ->
    'dg_read_field_def_TripUpdate.TripProperties'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dg_read_field_def_TripUpdate.TripProperties'(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> 'd_field_TripUpdate.TripProperties_trip_id'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        18 -> 'd_field_TripUpdate.TripProperties_start_date'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        26 -> 'd_field_TripUpdate.TripProperties_start_time'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        34 -> 'd_field_TripUpdate.TripProperties_shape_id'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        42 -> 'd_field_TripUpdate.TripProperties_trip_headsign'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        50 -> 'd_field_TripUpdate.TripProperties_trip_short_name'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        _ ->
            case Key band 7 of
                0 -> 'skip_varint_TripUpdate.TripProperties'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
                1 -> 'skip_64_TripUpdate.TripProperties'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
                2 -> 'skip_length_delimited_TripUpdate.TripProperties'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
                3 -> 'skip_group_TripUpdate.TripProperties'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
                5 -> 'skip_32_TripUpdate.TripProperties'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData)
            end
    end;
'dg_read_field_def_TripUpdate.TripProperties'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, _) ->
    S1 = #{},
    S2 = if F@_1 == '$undef' -> S1;
            true -> S1#{trip_id => F@_1}
         end,
...
'd_field_TripUpdate.TripProperties_trip_id'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_TripUpdate.TripProperties_trip_id'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_TripUpdate.TripProperties_trip_id'(<<0:1, X:7, Rest/binary>>, N, Acc, F, _, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_TripUpdate.TripProperties'(RestF, 0, 0, F, NewFValue, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'd_field_TripUpdate.TripProperties_start_date'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_TripUpdate.TripProperties_start_date'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_TripUpdate.TripProperties_start_date'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_TripUpdate.TripProperties'(RestF, 0, 0, F, F@_1, NewFValue, F@_3, F@_4, F@_5, F@_6, TrUserData).

'd_field_TripUpdate.TripProperties_start_time'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_TripUpdate.TripProperties_start_time'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_TripUpdate.TripProperties_start_time'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, _, F@_4, F@_5, F@_6, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_TripUpdate.TripProperties'(RestF, 0, 0, F, F@_1, F@_2, NewFValue, F@_4, F@_5, F@_6, TrUserData).

'd_field_TripUpdate.TripProperties_shape_id'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_TripUpdate.TripProperties_shape_id'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_TripUpdate.TripProperties_shape_id'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, _, F@_5, F@_6, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_TripUpdate.TripProperties'(RestF, 0, 0, F, F@_1, F@_2, F@_3, NewFValue, F@_5, F@_6, TrUserData).

'd_field_TripUpdate.TripProperties_trip_headsign'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_TripUpdate.TripProperties_trip_headsign'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_TripUpdate.TripProperties_trip_headsign'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, _, F@_6, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_TripUpdate.TripProperties'(RestF, 0, 0, F, F@_1, F@_2, F@_3, F@_4, NewFValue, F@_6, TrUserData).

'd_field_TripUpdate.TripProperties_trip_short_name'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_TripUpdate.TripProperties_trip_short_name'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_TripUpdate.TripProperties_trip_short_name'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_TripUpdate.TripProperties'(RestF, 0, 0, F, F@_1, F@_2, F@_3, F@_4, F@_5, NewFValue, TrUserData).

'skip_varint_TripUpdate.TripProperties'(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'skip_varint_TripUpdate.TripProperties'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'skip_varint_TripUpdate.TripProperties'(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'dfp_read_field_def_TripUpdate.TripProperties'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'skip_length_delimited_TripUpdate.TripProperties'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'skip_length_delimited_TripUpdate.TripProperties'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'skip_length_delimited_TripUpdate.TripProperties'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_TripUpdate.TripProperties'(Rest2, 0, 0, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'skip_group_TripUpdate.TripProperties'(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_TripUpdate.TripProperties'(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'skip_32_TripUpdate.TripProperties'(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'dfp_read_field_def_TripUpdate.TripProperties'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'skip_64_TripUpdate.TripProperties'(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'dfp_read_field_def_TripUpdate.TripProperties'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).
...
'merge_msg_TripUpdate.TripProperties'(PMsg, NMsg, _) ->
    ...
    S6 = case {PMsg, NMsg} of
             {_, #{trip_headsign := NFtrip_headsign}} -> S5#{trip_headsign => NFtrip_headsign};
             {#{trip_headsign := PFtrip_headsign}, _} -> S5#{trip_headsign => PFtrip_headsign};
             _ -> S5
         end,
    case {PMsg, NMsg} of
        {_, #{trip_short_name := NFtrip_short_name}} -> S6#{trip_short_name => NFtrip_short_name};
        {#{trip_short_name := PFtrip_short_name}, _} -> S6#{trip_short_name => PFtrip_short_name};
        _ -> S6
    end.
...
'v_msg_TripUpdate.TripProperties'(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{trip_headsign := F5} -> v_type_string(F5, [trip_headsign | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{trip_short_name := F6} -> v_type_string(F6, [trip_short_name | Path], TrUserData);
        _ -> ok
    end,
    ...
    [{{enum, 'FeedHeader.Incrementality'}, [{'FULL_DATASET', 0}, {'DIFFERENTIAL', 1}]},
     ...
     {{msg, 'TripUpdate.TripProperties'},
      [[{name, trip_id}, {fnum, 1}, {rnum, 2}, {type, string}, {occurrence, optional}, {opts, []}],
       ...
       [{name, trip_headsign}, {fnum, 5}, {rnum, 6}, {type, string}, {occurrence, optional}, {opts, []}],
       [{name, trip_short_name}, {fnum, 6}, {rnum, 7}, {type, string}, {occurrence, optional}, {opts, []}]]},
     {{msg, 'TripUpdate'},
