...
v_msg_FeedEntity(#{id := F1} = M, Path, TrUserData) ->
    ...
    case M of
        #{shape := F6} -> v_msg_Shape(F6, [shape | Path], TrUserData);
        _ -> ok
    end,
...
'v_msg_TripUpdate.StopTimeUpdate'(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{stop_time_properties := F7} -> 'v_msg_TripUpdate.StopTimeUpdate.StopTimeProperties'(F7, [stop_time_properties | Path], TrUserData);
        _ -> ok
    end,
...
v_msg_TripUpdate(#{trip := F1} = M, Path, TrUserData) ->
    ...
    case M of
        #{trip_properties := F6} -> 'v_msg_TripUpdate.TripProperties'(F6, [trip_properties | Path], TrUserData);
        _ -> ok
    end,
...
v_msg_VehiclePosition(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{multi_carriage_details := F11} ->
            if is_list(F11) ->
                   _ = ['v_msg_VehiclePosition.CarriageDetails'(Elem, [multi_carriage_details | Path], TrUserData) || Elem <- F11],
                   ok;
...
v_msg_Alert(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{image := F11} -> v_msg_TranslatedImage(F11, [image | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{image_alternative_text := F12} -> v_msg_TranslatedString(F12, [image_alternative_text | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{cause_detail := F13} -> v_msg_TranslatedString(F13, [cause_detail | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{effect_detail := F14} -> v_msg_TranslatedString(F14, [effect_detail | Path], TrUserData);
        _ -> ok
    end,
...
v_msg_TranslatedImage(#{} = M, Path, TrUserData) ->
    case M of
        #{localized_image := F1} ->
            if is_list(F1) ->
                   _ = ['v_msg_TranslatedImage.LocalizedImage'(Elem, [localized_image | Path], TrUserData) || Elem <- F1],
                   ok;
