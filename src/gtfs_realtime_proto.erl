...
-export_type(['VehicleDescriptor'/0, 'TimeRange'/0, 'TripDescriptor'/0, 'TranslatedString.Translation'/0, 'TranslatedString'/0, 'EntitySelector'/0, 'Alert'/0, 'Position'/0, 'VehiclePosition'/0, 'TripUpdate.StopTimeEvent'/0, 'TripUpdate.StopTimeUpdate'/0, 'TripUpdate'/0, 'FeedEntity'/0, 'FeedHeader'/0, 'FeedMessage'/0]).

-spec encode_msg('VehicleDescriptor'() | 'TimeRange'() | 'TripDescriptor'() | 'TranslatedString.Translation'() | 'TranslatedString'() | 'EntitySelector'() | 'Alert'() | 'Position'() | 'VehiclePosition'() | 'TripUpdate.StopTimeEvent'() | 'TripUpdate.StopTimeUpdate'() | 'TripUpdate'() | 'FeedEntity'() | 'FeedHeader'() | 'FeedMessage'(),'VehicleDescriptor' | 'TimeRange' | 'TripDescriptor' | 'TranslatedString.Translation' | 'TranslatedString' | 'EntitySelector' | 'Alert' | 'Position' | 'VehiclePosition' | 'TripUpdate.StopTimeEvent' | 'TripUpdate.StopTimeUpdate' | 'TripUpdate' | 'FeedEntity' | 'FeedHeader' | 'FeedMessage') -> binary().
...
d_field_TripDescriptor_schedule_relationship(<<0:1, X:7,
					     ...
					     F@_5, _, TrUserData) ->
    {NewFValue, RestF} =
	{'d_enum_TripDescriptor.ScheduleRelationship'(begin
...
dfp_read_field_def_TranslatedString(<<>>, 0, 0, R1,
				    TrUserData) ->
    #{translation => lists_reverse(R1, TrUserData)};
...
d_field_TranslatedString_translation(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   ...
			   {id('d_msg_TranslatedString.Translation'(Bs,
								    TrUserData),
			       TrUserData),
			    Rest2}
			 end,
...
d_field_EntitySelector_trip(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_TripDescriptor(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_EntitySelector(RestF, 0, 0, F@_1,
...
dfp_read_field_def_Alert(<<>>, 0, 0, R1, R2, F@_3, F@_4,
    ...
    S1 = #{active_period => lists_reverse(R1, TrUserData),
	   informed_entity => lists_reverse(R2, TrUserData)},
    S2 = if F@_3 == '$undef' -> S1;
	    true -> S1#{cause => F@_3}
	 end,
    S3 = if F@_4 == '$undef' -> S2;
    ...
    S5 = if F@_6 == '$undef' -> S4;
	    true -> S4#{header_text => F@_6}
	 end,
    if F@_7 == '$undef' -> S5;
       true -> S5#{description_text => F@_7}
    end;
...
d_field_Alert_active_period(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_TimeRange(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
...
d_field_Alert_informed_entity(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_EntitySelector(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
...
d_field_Alert_cause(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    {NewFValue, RestF} = {'d_enum_Alert.Cause'(begin
...
d_field_Alert_effect(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    {NewFValue, RestF} = {'d_enum_Alert.Effect'(begin
						  <<Res:32/signed-native>> =
						      <<(X bsl N +
							   Acc):32/unsigned-native>>,
						  Res
...
d_field_Alert_url(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_TranslatedString(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_Alert(RestF, 0, 0, F@_1, F@_2, F@_3,
...
d_field_Position_latitude(<<_:16, 1:1, _:7, _:1, 127:7,
			    Rest/binary>>,
			  Z1, Z2, _, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_Position(Rest, Z1, Z2, nan, F@_2,
				F@_3, F@_4, F@_5, TrUserData);
d_field_Position_latitude(<<Value:32/little-float,
			    Rest/binary>>,
			  Z1, Z2, _, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_Position(Rest, Z1, Z2, Value, F@_2,
				F@_3, F@_4, F@_5, TrUserData).
...
d_field_Position_longitude(<<_:16, 1:1, _:7, _:1, 127:7,
			     Rest/binary>>,
			   Z1, Z2, F@_1, _, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_Position(Rest, Z1, Z2, F@_1, nan,
				F@_3, F@_4, F@_5, TrUserData);
d_field_Position_longitude(<<Value:32/little-float,
			     Rest/binary>>,
			   Z1, Z2, F@_1, _, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_Position(Rest, Z1, Z2, F@_1, Value,
				F@_3, F@_4, F@_5, TrUserData).
...
d_field_Position_speed(<<_:16, 1:1, _:7, _:1, 127:7,
			 Rest/binary>>,
		       Z1, Z2, F@_1, F@_2, F@_3, F@_4, _, TrUserData) ->
    dfp_read_field_def_Position(Rest, Z1, Z2, F@_1, F@_2,
				F@_3, F@_4, nan, TrUserData);
d_field_Position_speed(<<Value:32/little-float,
			 Rest/binary>>,
		       Z1, Z2, F@_1, F@_2, F@_3, F@_4, _, TrUserData) ->
    dfp_read_field_def_Position(Rest, Z1, Z2, F@_1, F@_2,
				F@_3, F@_4, Value, TrUserData).
...
d_field_VehiclePosition_vehicle(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_VehicleDescriptor(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
...
d_field_VehiclePosition_position(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_Position(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_VehiclePosition(RestF, 0, 0, F@_1,
				       F@_2,
...
d_field_VehiclePosition_current_status(<<0:1, X:7,
					 Rest/binary>>,
				       ...
				       F@_7, F@_8, F@_9, TrUserData) ->
    {NewFValue, RestF} =
	{'d_enum_VehiclePosition.VehicleStopStatus'(begin
						      <<Res:32/signed-native>> =
							  <<(X bsl N +
							       Acc):32/unsigned-native>>,
						      Res
...
d_field_VehiclePosition_congestion_level(<<0:1, X:7,
    ...
    {NewFValue, RestF} =
	{'d_enum_VehiclePosition.CongestionLevel'(begin
						    <<Res:32/signed-native>> =
							<<(X bsl N +
							     Acc):32/unsigned-native>>,
						    Res
...
d_field_VehiclePosition_occupancy_status(<<0:1, X:7,
    ...
    {NewFValue, RestF} =
	{'d_enum_VehiclePosition.OccupancyStatus'(begin
						    <<Res:32/signed-native>> =
							<<(X bsl N +
							     Acc):32/unsigned-native>>,
						    Res
...
'd_field_TripUpdate.StopTimeUpdate_arrival'(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id('d_msg_TripUpdate.StopTimeEvent'(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    'dfp_read_field_def_TripUpdate.StopTimeUpdate'(RestF, 0,
...
'd_field_TripUpdate.StopTimeUpdate_schedule_relationship'(<<0:1,
							  ...
							  TrUserData) ->
    {NewFValue, RestF} =
	{'d_enum_TripUpdate.StopTimeUpdate.ScheduleRelationship'(begin
								   <<Res:32/signed-native>> =
								       <<(X bsl
									    N
									    +
...
dfp_read_field_def_TripUpdate(<<>>, 0, 0, F@_1, F@_2,
    ...
    S1 = #{trip => F@_1,
	   stop_time_update => lists_reverse(R1, TrUserData)},
    S2 = if F@_2 == '$undef' -> S1;
	    true -> S1#{vehicle => F@_2}
	 end,
    S3 = if F@_4 == '$undef' -> S2;
	    true -> S2#{timestamp => F@_4}
	 end,
    if F@_5 == '$undef' -> S3;
       true -> S3#{delay => F@_5}
    end;
...
d_field_TripUpdate_stop_time_update(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id('d_msg_TripUpdate.StopTimeUpdate'(Bs,
								 TrUserData),
			       TrUserData),
			    Rest2}
			 end,
...
d_field_FeedEntity_trip_update(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_TripUpdate(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
...
d_field_FeedEntity_vehicle(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_VehiclePosition(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_FeedEntity(RestF, 0, 0, F@_1, F@_2,
...
d_field_FeedEntity_alert(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_Alert(Bs, TrUserData), TrUserData), Rest2}
			 end,
    dfp_read_field_def_FeedEntity(RestF, 0, 0, F@_1, F@_2,
				  F@_3, F@_4,
				  if Prev == '$undef' -> NewFValue;
...
d_field_FeedHeader_incrementality(<<0:1, X:7,
				  ...
				  N, Acc, F@_1, _, F@_3, TrUserData) ->
    {NewFValue, RestF} =
	{'d_enum_FeedHeader.Incrementality'(begin
					      <<Res:32/signed-native>> = <<(X
									      bsl
									      N
									      +
...
dfp_read_field_def_FeedMessage(<<>>, 0, 0, F@_1, R1,
			       TrUserData) ->
    #{header => F@_1,
      entity => lists_reverse(R1, TrUserData)};
...
d_field_FeedMessage_header(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_FeedHeader(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
...
d_field_FeedMessage_entity(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_FeedEntity(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
...
get_msg_names() ->
    ['VehicleDescriptor', 'TimeRange', 'TripDescriptor',
     'TranslatedString.Translation', 'TranslatedString',
     'EntitySelector', 'Alert', 'Position',
     'VehiclePosition', 'TripUpdate.StopTimeEvent',
     'TripUpdate.StopTimeUpdate', 'TripUpdate', 'FeedEntity',
     'FeedHeader', 'FeedMessage'].
