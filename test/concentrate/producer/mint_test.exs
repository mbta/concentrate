defmodule Concentrate.Producer.MintTest do
  ...
  #     state = %Concentrate.Producer.Mint.State{machine: machine}
  ...
  #     machine = StateMachine.init("url", parser: &[&1])
  #     state = %Concentrate.Producer.Mint.State{machine: machine, demand: 1}
  #     response = %Mint.Response{status_code: 200, body: "body"}
